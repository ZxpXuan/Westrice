...
public class RaycastCollider2D {
	...
	public RaycastHit2D GetCollision(int layerMask, float extraDistance) {
		return Physics2D.Raycast (transform.position + transform.localRotation * offset, transform.localRotation * GetVectorForDirection(), distance + extraDistance, layerMask);
	}
